...
open {runner_py.resolve()}
crbnpland {config_path.resolve()}
log save {str((analysis_root / 'chimerax_plan_d_log.html').resolve())}
exit
""",
    )
    atomic_write_text(
...
License Agreement and requires pressing Accept before the DMG download. The
license must be accepted by the user or licensee before installation. The Plan D runner also
